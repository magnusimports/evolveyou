...
export const anamneseQuestions = [
  ...
  {
    id: 'food_allergies',
    title: 'Quais alimentos você tem alergia?',
    subtitle: 'Liste todos os alimentos que causam reações alérgicas',
    type: 'text_area',
    placeholder: 'Ex: amendoim, camarão, ovos...',
    conditional: {
      dependsOn: 'dietary_restrictions',
      showIf: ['food_allergies']
    }
  },
  {
    id: 'meal_frequency',
    ...
    options: [
      ...
      { id: 'intermittent', label: 'Jejum Intermitente', description: 'Janela alimentar restrita' }
    ]
  },
  {
    id: 'intermittent_fasting',
    title: 'Qual protocolo de jejum você segue?',
    subtitle: 'Vamos adequar as refeições à sua janela alimentar',
    type: 'single_choice',
    options: [
      { id: '16_8', label: '16:8', description: '16h jejum, 8h alimentação' },
      { id: '18_6', label: '18:6', description: '18h jejum, 6h alimentação' },
      { id: '20_4', label: '20:4', description: '20h jejum, 4h alimentação' },
      { id: '24h', label: '24h', description: 'Jejum de 24 horas' },
      { id: 'other', label: 'Outro protocolo' }
    ],
    conditional: {
  ...
  {
    id: 'disliked_foods',
    title: 'Quais alimentos você não gosta ou evita?',
    subtitle: 'Não vamos incluir nada que você não goste',
    type: 'text_area',
